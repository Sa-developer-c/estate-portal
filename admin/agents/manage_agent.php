...
<div class="card card-outline rounded-0 card-primary">
	<div class="card-body">
		<div class="container-fluid">
			...
			<form action="" id="manage-agent">	
				...
				<div class="row">
					<div class="col-md-6">
						<label for="password" class="control-label">كلمة مرور جديدة <sup>*</sup></label>
				...
				<div class="row">
					<div class="col-md-4">
						<label for="status" class="control-label">الحالة <sup>*</sup></label>
						<select name="status" id="status" class="form-control form-control-sm rounded-0" required="required">
							<option value="1" <?=isset($status) && $status == '1' ? "selected" : "" ?>>متوفر</option>
							<option value="0" <?=isset($status) && $status == '0' ? "selected" : "" ?>>مُباع</option>
						</select>
					</div>
	...
	<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-primary" form="manage-agent">تحديث</button>
				</div>
			</div>
		</div>
</div>
