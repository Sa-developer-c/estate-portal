<h1>أهلاً بك في  <?php echo $_settings->info('name') ?></h1>
<hr>
<div class="row">
        <div class="col-12 col-sm-6 col-md-6">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">أنواع العقارات</span>
          ...
          <div class="col-12 col-sm-6 col-md-6">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">جميع الخصائص</span>
                <span class="info-box-number">
                  <?php 
          ...
          <div class="col-12 col-sm-6 col-md-6">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">متوفر</span>
                <span class="info-box-number">
                  <?php 
