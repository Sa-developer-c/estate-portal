...
<div class="card card-outline rounded-0 card-primary">
	<div class="card-header">
		<h3 class="card-title">قائمة الخصائص</h3>
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("هل أنت متأكد من حذف هذا المرفق بشكل دائم؟","delete_amenity",[$(this).attr('data-id')])
		})
		$('#create_new').click(function(){
			uni_modal("<i class='fa fa-plus'></i>إضافة مرافق جديدة","amenities/manage_amenity.php")
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> تحديث تفاصيل الخصائص","amenities/manage_amenity.php?id="+$(this).attr('data-id'))
		})
		$('.table').dataTable({
			columnDefs: [
