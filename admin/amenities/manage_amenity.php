...
<div class="container-fluid">
	<form action="" id="amenity-form">
		...
		<div class="form-group">
			<label for="status" class="control-label">النوع</label>
			<select name="type" id="type" class="form-control form-control-sm rounded-0" required>
			<option value="1" <?php echo isset($type) && $type == 1 ? 'selected' : '' ?>>داخلي</option>
			<option value="2" <?php echo isset($type) && $type == 2 ? 'selected' : '' ?>>خارجي</option>
			</select>
		</div>
		<div class="form-group">
