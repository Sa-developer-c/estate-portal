    ...
    <div class="card card-outline card-primary rounded-0 shadow" style="direction: rtl;text-align: right;">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="./?page=real_estate/manage_estate&id=<?= isset($id) ? $id : '' ?>" class="btn btn-flat btn-sm bg-gradient-primary"><i class="fa fa-edit"></i>تعديل التفاصيل</a>
                <button type="button" class="btn btn-flat btn-sm bg-gradient-danger" id="delete_estate"><i class="fa fa-trash"></i> حذف</button>
            </div>
        </div>
        <div class="card-body">
                ...
                <div class="col-md-12">
                    ...
                    <div class="mapouter">
                        <div class="gmap_canvas">
                            <!-- <iframe width="100%" height="500" id="gmap_canvas" src="<?= $coordinates ?>" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe> -->
...
$(function(){
    ...
    $('#delete_estate').click(function(){
        _conf("هل أنت متأكد من حذف هذا العقار بشكل دائم؟","delete_estate",[])
    })
})
